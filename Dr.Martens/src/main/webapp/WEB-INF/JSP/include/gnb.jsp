...
<div id="MainGnb">
	<div class="gnb_inr">
				...
				<ul class="gnb_list swiper-slide">
					<!-- <li class="list01 mt0">
						...
						<ul class="sch_menu">
							...
							<li class="sch_list">
								<a href="javascript:;">
									<img src="/resources/img/main/bm6.jpg" alt="" />
									<span>카카오 간편가입 이벤트</span>
								</a>
							</li>
							<li class="sch_list">
					...
					<!-- <li class="list01">
						...
						<ul>
							...
							<li class="list02"><a href="">주니어(6세이상)</a></li>
					...
					<li class="list01">
						<p>액세서리</p>
						<ul>
							<li class="list02"><a href="">가방</a></li>
							<li class="list02"><a href="">슈케어</a></li>
							<li class="list02"><a href="">양말</a></li>
					...
					<!-- <li class="list01">
						...
						<ul>
							...
							<li class="list02"><a href="">HOW TO CARE</a></li>
		...
		<div class="gnb_evt_wrap">
			...
			<div class="gnb_evt_scroll swiper-scrollbar"></div>
		</div>
	</div>
</div>