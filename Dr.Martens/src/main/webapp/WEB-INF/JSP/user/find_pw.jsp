...
<script>document.title = "DrMartens 비밀번호 찾기";</script>
<!--  -->
<!-- 페이지 영역 -->
<div id="container">
	<div id="content">
		...
		<div id="subHead">
			<div class="subHead_back">
				...
				<!-- <div class="subHead_title">비밀번호 찾기</div> -->
			</div>
		</div>
		<!-- //서브페이지 상단 -->
		<main id="user">
			...
			<ul class="find_util cf">
				<li class="id_find"><a href="/DrMarten/user/find_id">아이디 찾기</a></li>
				<li class="pw_find find_on"><a href="/DrMarten/user/find_pw">비밀번호 찾기</a></li>
			</ul>
			<div class="find_wrap mt30">
				<form id="find_id_form" action="/DrMarten/user/find_pw" method="post">
					...
					<div class="mt20">
						<button type="submit" class="cmBtn fullWidth black large fw700 mb10">비밀번호 찾기</button>
					</div>
			...
			<%-- //비밀 번호 찾기
			<form id="find_pw_form" action="/DrMarten/user/find_pw" method="post">
