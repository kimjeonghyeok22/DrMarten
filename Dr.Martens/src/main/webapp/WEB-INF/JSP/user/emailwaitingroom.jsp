...
<header id="header">
	...
	<div id="main" style="margin-top : 125px;  min-height: calc(100vh - 429px);">
		<div class="inner" style="height:fit-content; padding-top : 200px;">
		   
			    <div class="wrap" style="text-align:center;">
					<span style="font-size: 18px; color : #000; line-height: 40px;">입력하신 이메일 주소로 인증 메일을 보냈습니다.<br>
					메일에 있는 링크를 통해 회원가입을 완료해주세요.</span><br>
					<button type="button" onclick="location.href='/DrMarten';" class="cmBtn  yellow large fw700" style="width : 550px; margin : 30px 0 0;">메인으로</button>
			</div>
		</div>
	</div>
