                ...
                <div class="inner">
					...
					<form action="/DrMarten/product/files/add" method="post"
						...
						<div class="dmField dmInput name">
						    ...
						    <input type="text" name="name" value="" class="dmField_input" placeholder="제품_이름을_입력해주세요">
						</div>
						...
						<div class="dmField dmInput w33">
						    ...
						    <input type="text" name="made" value="" class="dmField_input" placeholder="제조국가">
						</div>
								<div class="dmField dmInput w33">
							<label class="dmField_label">원재료</label>
						    <input type="text" name="material" value="" class="dmField_input" placeholder="원재료">
						</div>
								<div class="dmField dmInput w33">
			            ...
			            <div class="dmField dmInput">
						    ...
						    <input type="text" name="price" value="" class="dmField_input" placeholder="가격">
						</div>
