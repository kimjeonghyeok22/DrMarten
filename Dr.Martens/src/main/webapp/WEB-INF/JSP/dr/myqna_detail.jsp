...
function deleteThis(){
	...
	$.ajax({
		url : '/dr/myqna/delete/${board.board_num}',
		method : 'get',
		cacht : false,
		dataType : 'json',
...
<div class="btn_wrap">
<button type="button" onclick="location.href='/dr/myqna/list';">목록</button>
<button type="button" onclick="location.href='/dr/myqna/edit/${board.board_num}';">수정</button>
