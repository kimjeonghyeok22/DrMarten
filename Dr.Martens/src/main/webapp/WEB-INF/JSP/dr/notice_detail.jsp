...
function deleteThis(){
	...
	$.ajax({
		url : '/dr/notice/delete/${board.board_num}',
		method : 'get',
		cacht : false,
		dataType : 'json',
		success : function(res){
			alert(res.deleted?'삭제성공':'삭제실패');
			location.href='/dr/notice/list';
		},
...
<div class="btn_wrap">
<button type="button" onclick="location.href='/dr/notice/list';">목록</button>
<button type="button" onclick="location.href='/dr/notice/edit/${board.board_num}';">수정</button>
