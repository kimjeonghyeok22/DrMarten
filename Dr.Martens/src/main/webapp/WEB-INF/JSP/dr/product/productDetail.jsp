...
<head>
	...
	<style type="text/css">
		...
		input[type="text"]:read-only {background-color : #fff; color : #111111;}
                ...
                <div class="inner">
                        ...
                        <form action="/DrMarten/product/files/add" method="post" enctype="multipart/form-data" id="product_form">
                            ...
                            <div class="dmField dmInput w33">
                                ...
                                <input type="text" name="material" value="${product.color}" class="dmField_input"  readonly="readonly"> 
                            </div>
                            ...
                            <div class="dmField dmInput w33">
                                ...
                                <input type="text" name="price" value="${product.discount}%" class="dmField_input" readonly="readonly">
                            </div>
                            <div class="btn_wrap">
