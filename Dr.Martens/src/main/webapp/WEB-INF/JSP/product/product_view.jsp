            ...
            <body>
                            ...
                            <ul class="fz26 fw700 categoraegorae">
                                <li id="toc-toggle" onclick="openCloseToc()"> <span id="catVal">성별</span> <span><img class="rowV" id="rowV" src="http://localhost/resources/img/Up_arrow_transparent.png"/></span>
                                    <ul class="closeList" id="category">
                                        <li> <a href="/product/category/male" class="cate">　남자</a> </li>
                                        <li> <a href="/product/category/female" class="cate">　여자</a> </li>
                                    </ul>
                                </li>
                                <li id="toc-toggle_2" onclick="openCloseToc2()"> <span>종류</span> <span><img class="rowV" id="rowV2" src="http://localhost/resources/img/Up_arrow_transparent.png"/></span>
                                    <ul class="closeList" id="category2">
                                        <li> <a href="/product/category/sandals" class="cate">　샌들</a> </li>
                                        <li> <a href="/product/category/boots" class="cate">　부츠</a> </li>
                                    </ul>
                                </li>
                                <li id="toc-toggle_3" onclick="openCloseToc3()"> <span>할인제품</span> <span><img class="rowV" id="rowV3" src="http://localhost/resources/img/Up_arrow_transparent.png"/></span>
                                    <ul class="closeList" id="category3">
                                        <li> <a href="/product/category/sandals/10" class="cate">　샌들 10%</a> </li>
                                    </ul>
                                </li>
                                <li id="toc-toggle_4" onclick="location.href='/product/category/online_only'"> <span>온라인 단독</span> </li>
                                <li id="toc-toggle_5" onclick="location.href='/product/category/vegan'"> <span>친환경 비건</span> </li>
                            </ul>
                        </div>
                        <div id="right_list">
                            <div id="reset_by_category">
                                <c:forEach items="${product.list}" var="product">
                                    <form id="list" onclick="location.href='/product/detail_product/${product.product_code}'"> <img src="http://localhost/${product.attach[0].fpath}${product.name}_main.png" />
                                        <br>
               ...
               <!-- <div class="test_mode">
                    <form action="/product/files/add" method="post" enctype="multipart/form-data">
                        <h2>제품 등록</h2> 제품이름
                        <input type="text" name="name" value="willsmith">
                        <br> File
                        <input type="file" name="files" multiple="multiple">
                        <br> 제조국가
                        <input type="text" name="made" value="china">
                        <br> 원재료
                        <input type="text" name="material" value="smith">
                        <br> 색상
                        <input type="text" name="color" value="black">
                        <br> 성별
                        <input type="text" name="gender" value="혼용">
                        <br> 카테고리
                        <input type="text" name="category" value="sandles">
                        <br> 가격
                        <input type="text" name="price" value="200000">
                        <br> 사이즈
                        <input type="text" name="size[0].product_size" value="240">
                        <br> 수량
                        <input type="text" name="size[0].product_count" value="5">
                        <br> 사이즈
                        <input type="text" name="size[1].product_size" value="250">
                        <br> 수량
                        <input type="text" name="size[1].product_count" value="10">
                        <br>
                        <button type="submit">저장</button>
                    </form>
                    <form action="/product/files/addStock" method="post">
                        <h2>제품 사이즈 추가</h2> 제품이름
                        <input type="text" name="name" value="willsmith">
                        <br> 사이즈
                        <input type="text" name="size[0].product_size" value="240">
                        <br> 수량
                    ...
                    <h2>제품 사진 추가</h2>
                    <form action="/product/files/addFiles" method="post" enctype="multipart/form-data"> 제품이름
                        <input type="text" name="name" value="willsmith">
                        <br> File
                        <input type="file" name="files" multiple="multiple">
                        <br>
                    ...
                    <form action="/product/erase" method="post"> [제품이름]
                        <input type="text" name="name" value="willsmith3">
                        <button type="submit">삭제하기</button>
                    </form>
                    <form action="/product/sell" method="post">
                        <h3>[[x]제품[x]사이즈[x]갯수가 판매 되었습니다.]</h3> [제품이름]
                        <input type="text" name="name" value="willsmith">
                        <br> [사이즈]
                        <input type="text" name="product_size" value="240">
                        <br> [판매된 갯수]
