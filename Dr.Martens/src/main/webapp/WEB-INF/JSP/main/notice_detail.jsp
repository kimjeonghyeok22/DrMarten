    ...
    <footer id="footer">
        ...
        <div class="gotoTop">
            <button class="gotoTop_btn">
                <!-- <img src="/resources/img/floating_top.png" alt="맨위로 가기" /> --></button>
        </div>
        <!-- //top btn -->
        <div class="ft_inner">
            <div class="ft_top cf">
                <div class="ft_left">
                    ...
                    <p class="ft_top_info_row"> <span class="ft_top_info_column">신림이젠컴퓨터아카데미</span> <span class="ft_top_info_column">사업자번호 : 000-00-00000</span> </p>
                    <p class="ft_top_info_row"> <span class="ft_top_info_column">통신판매업 신고 : 0000 - 서울관악 - 0000호</span> <span class="ft_top_info_column">개인정보관리책임자 : 홍길동</span> <span class="ft_top_info_column">대표이사 : 스프링부트</span> </p>
                    <p class="ft_top_info_row"> <span class="ft_top_info_column"><strong>문의전화 : 0000-0000</strong> (9:30AM ~ 6PM 점심시간 13:10~14:10)</span> <span class="ft_top_info_column">이메일 : hello@email.co.kr</span> </p>
                    <p class="ft_top_info_row"> <span class="ft_top_info_column">팩스 : 02-000-0000</span> <span class="ft_top_info_column">호스팅 제공 : localhost</span> </p>
                    <p class="ft_top_info_row"> <span class="ft_top_info_column">All Images and Contents Copyright (c) 2022 Dr. Martens-Airwair Korea Ltd. All Rights Reserved.</span> </p>
                </div>
            ...
            <div class="ft_btm">
                ...
                <div class="sns_box"> <a href="javascript:;" class="ml0"><i class="fa-brands fa-twitter"></i><span class="text_hiden">트위터</span></a> <a href="javascript:;"><i class="fa-brands fa-youtube"></i><span class="text_hiden">유투브</span></a> <a href="javascript:;"><i class="fa-brands fa-facebook-f"></i><span class="text_hiden">페이스북</span></a> <a href="javascript:;"><i class="fa-brands fa-instagram"></i><span class="text_hiden">인스타그램</span></a> </div>
            </div>
        </div>
    </footer>
</body>
