    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
        ...
        <body>
            ...
            <div id="main" class="loginForm" style="margin-top : 180px;">
                <div class="inner"> <strong style="font-size : 28px; color:#000; font-weight: bold;">로그인</strong>
                    <div class="welcome"> <strong style="font-size : 28px; color:#000; font-weight: bold;">어서오세요</strong>
                        <br> <span style="font-size: 18px; color : #000">닥터마틴에 오신걸 환영합니다</span> </div>
                    <div class="wrap">
                        <div class="login_wrap mem"> <span>로그인</span>
                            <form id="login_form" action="/DrMarten/user/login" method="post">
                                <div class="dmField dmInput mb30">
                                    ...
                                    <div class="dmField_input_box">
                                        <input name="u_email" type="text" class="dmField_input" placeholder="이메일 형식 입력"> </div>
                                </div>
                                <div class="dmField dmInput mb30">
                                    <label class="dmField_label">비밀번호</label>
                                    <div class="dmField_input_box">
                                        <input name="u_pw" type="password" class="dmField_input" placeholder=""> </div>
                                </div> <a href="/DrMarten/user/find_id" class="findIDPW">아이디</a>/<a href="/DrMarten/user/find_pw" class="findIDPW">비밀번호 찾기</a>
                                <br>
                                <button type="submit" class="cmBtn fullWidth black large fw700 mb10">로그인</button>
                                <br> <a href="/DrMarten/user/signUp" class="cmBtn fullWidth yellow large fw700">회원가입</a> </form>
                        </div>
                        <div class="login_wrap not_mem"> <span>비회원 주문조회</span>
                            <form>
                                <div class="dmField dmInput mb30">
                                    <label class="dmField_label">주문번호</label>
                                    <div class="dmField_input_box">
                                        <input name="order_num" type="text" class="dmField_input" placeholder=""> </div>
                                </div>
                                <div class="dmField dmInput mb30">
                                    <label class="dmField_label">이메일</label>
                                    <div class="dmField_input_box">
                                        <input name="email" type="text" class="dmField_input" placeholder=""> </div>
                                </div>
                                <a href="#" class="findIDPW"></a>
                                <br>
